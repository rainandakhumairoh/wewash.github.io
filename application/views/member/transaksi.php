        ...
        <table class="table table-bordered" id="konten" width="100%">
          ...
          <tbody ng-repeat="trx in datas">
            <tr>
              ...
              <td>{{trx.tgl_ambil}}</td>
              <td ng-repeat="detail in trx.detail">{{detail.jenis}}</td>
              <td ng-repeat="detail in trx.detail">{{detail.berat}}</td>
              <td ng-repeat="detail in trx.detail">{{detail.jumlah}}</td>
              <td ng-repeat="detail in trx.detail">{{detail.bayar}}</td>
              <td >{{trx.total}}</td>
            </tr>
          </tbody>
        </table>
